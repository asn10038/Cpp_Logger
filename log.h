...
#ifndef SYNTEST_LOG_H
#define SYNTEST_LOG_H
...
/* These are the variables to configure for the project */
/* log.cpp will read these environment variables when making decisions */

#define NAMESPACE SynTest
#define LOGGING_GLOBAL SYNTEST_LOG
#define TO_STRING(x) #x
#define LOG_BUFFER SYNTEST_LOG_BUFFER
#define LOG_FILE SYNTEST_LOG_FILE
#define APPEND_LOG_FILE SYNTEST_APPEND_LOG_FILE

/* USAGE: LOGGING_GLOBAL=class1,class2,class3... ./executable [args...] */
/* To log all: LOGGING_GLOBAL=all ... */
/* with special levels */
/* LOGGING_GLOBAL=class1:level,class2:level ... */
/* Note: class names do not include file endings */
...
/**
    Dealing with kernel error codes 
*/
